...
| Q-004   | Long-term memory promotion gate                                    | ADR-0006      | §12.2, §12.3               | §11.3            | AC13                                          |
| Q-005   | What `/forget` deletes                                             | DEC-006       | §7, §8.1, Appendix D       | §6.4, §7.x       | AC26 (pending)                                |
| Q-006   | Memory corrections (supersede, not overwrite)                      | DEC-007       | §12, Appendix D            | §11.3            | —                                             |
| Q-007   | Attachment default save policy                                     | ADR-0006      | §12.8.3, §13.5             | §9.3             | AC22, AC23                                    |
| Q-008   | Where artifact meaning lives                                       | ADR-0004      | §12.8, Appendix D          | §5.2, §6.4, §12  | AC24                                          |
| Q-009   | Client-side encryption                                             | DEC-008       | §15                        | §12              | 05_RUNBOOK §9                                 |
| Q-010   | Retention durations                                                | DEC-005       | §12.8.2                    | §12              | 05_RUNBOOK §7                                 |
| Q-011   | BOOTSTRAP_WHOAMI lifecycle                                         | DEC-009       | §8.3                       | §9.2, §16.1      | 05_RUNBOOK §12; AC01                          |
| Q-012   | Redaction pattern coverage                                         | DEC-010       | §15                        | §13.2            | AC10                                          |
...
| Q-015   | Parser failure still delivers an answer                            | —             | §16.3                      | §8.3, §7.3       | AC15                                          |
| Q-016   | Claude Code side effects as chat runtime                           | ADR-0005      | §11, §15                   | §8.1, §8.4       | SP-05; AC11                                   |
...
| Q-021   | Restart user-notification policy                                   | DEC-016       | §8.5, §13.3                | §6.2, §15        | 05_RUNBOOK §4; AC06                           |
| Q-022   | `/doctor` quick vs deep                                            | DEC-017       | §8.7                       | §16              | AC16                                          |
| Q-023   | S3 degraded endurance                                              | DEC-018       | §8.7                       | §12.5, §16.1     | 05_RUNBOOK §7; AC08, AC16                     |
...
| ADR-0002 | Use Telegram long polling                                | §13.1, §8.2       | §9.1, §9.4, §9.5        | SP-02; AC17                    |
| ADR-0003 | Use SQLite (WAL) as active state SoT                     | §12.7, Appendix D | §3.1, §5, §6            | SP-01; AC19                    |
| ADR-0004 | Use S3 as an artifact archive                            | §12.7, §12.8      | §6.4, §9.3, §12         | SP-08; AC08, AC12, AC16, AC21–AC25 |
| ADR-0005 | Ship Claude as the only P0 provider                      | §5, §11           | §8                      | SP-04, SP-05, SP-06; AC11      |
| ADR-0006 | Explicit memory + attachment promotion                   | §12.2, §12.8      | §6.4, §9.3, §11.3       | AC22, AC23                     |
| ADR-0007 | Provider session as cache, internal session as truth     | §12.4             | §8.2, §10.2             | SP-06                          |
| ADR-0008 | Durable Telegram inbound / outbound ledgers              | §13               | §6.1, §6.3, §7.1, §9    | SP-02, SP-03; AC05, AC06, AC08 |
...
| DEC-002 | Redaction is a single-module boundary                        | §15                      | §13                | AC10                         |
| DEC-003 | Keep PRD at `docs/PRD.md`                                    | —                        | —                  | Playbook §4                  |
| DEC-004 | Bun.S3Client path-style + AWS SDK fallback                   | §12.7                    | §12                | SP-08; AC16                  |
...
| DEC-009 | BOOTSTRAP_WHOAMI with 30-min auto-expiry                     | §8.3                     | §9.2, §16.1        | 05_RUNBOOK §12; AC01         |
| DEC-010 | P0 redaction pattern list                                    | §15                      | §13.2              | AC10                         |
...
| DEC-016 | Restart user-notification policy                             | §8.5, §13.3              | §6.2, §15          | 05_RUNBOOK §4; AC06          |
| DEC-017 | `/doctor` single command, typed output                       | §8.7                     | §16                | AC16                         |
| DEC-018 | S3 degraded thresholds                                       | §8.7                     | §12.5, §16.1       | 05_RUNBOOK §7; AC08, AC16    |
...
| ---- | ------------------------------------------------------------------- | -------------------------- | ---------------------- |
| AC01 | Unauthorized user produces no job                                   | DEC-009                    | SP-02                  |
| AC02 | Authorized DM creates one job, transitions cleanly                  | DEC-001                    | SP-01, SP-04, SP-06    |
| AC03 | Redacted raw events persisted                                       | DEC-002, DEC-010           | SP-04                  |
| AC04 | Final response sent + saved as turn                                 | ADR-0008                   | SP-02, SP-04           |
| AC05 | Duplicate `update_id` → one job                                     | ADR-0008                   | SP-03                  |
| AC06 | Restart reconciles running jobs                                     | DEC-016                    | SP-01, SP-07           |
| AC07 | `/summary`, `/end` produce summary + sync                           | DEC-019                    | SP-06, SP-08           |
| AC08 | S3 outage doesn't block delivery                                    | ADR-0004, DEC-018          | SP-08                  |
| AC09 | Runtime/output/prompt limits terminate subprocess                   | —                          | SP-07                  |
| AC10 | Secrets never appear in persisted rows                              | DEC-002, DEC-010           | SP-04, SP-05           |
| AC11 | Claude runs without interactive prompts                             | ADR-0005                   | SP-05                  |
| AC12 | `storage_sync` failure doesn't roll back                            | ADR-0004                   | SP-08                  |
| AC13 | Summary items carry provenance and confidence                       | ADR-0006                   | SP-06                  |
| AC14 | `/cancel` terminates whole subprocess group                         | —                          | SP-07                  |
| AC15 | Parser fixture normalizes to `final_text`                           | —                          | SP-04                  |
| AC16 | `/doctor` S3 smoke passes                                           | DEC-017, DEC-018           | SP-08                  |
| AC17 | Long polling without bot framework                                  | ADR-0002                   | SP-02                  |
| AC18 | Provider subprocess terminates by timeout / abort                   | —                          | SP-07                  |
| AC19 | WAL + atomic claim holds across restart                             | ADR-0003                   | SP-01                  |
| AC20 | Dependency list within allowlist                                    | ADR-0001                   | —                      |
| AC21 | Telegram attachment captured into `storage_objects`                 | ADR-0004                   | SP-02, SP-08           |
| AC22 | Attachment stays `session` without save intent                      | ADR-0006                   | SP-02                  |
| AC23 | Explicit save promotes to `long_term`                               | ADR-0006                   | SP-02, SP-08           |
| AC24 | S3 keys carry no user-facing semantics                              | ADR-0004                   | SP-08                  |
| AC25 | `storage_sync` failures retain state cleanly                        | ADR-0004                   | SP-08                  |
