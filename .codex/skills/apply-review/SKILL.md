...
- **Project conventions**: respect `AGENTS.md` and existing repo guidance/code style. If a review item conflicts with a project rule, flag it and follow the rule.
