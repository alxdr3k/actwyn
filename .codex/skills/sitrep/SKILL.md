...
4. `AGENTS.md` — repo-local agent guidance
5. README.md, `docs/ARCHITECTURE.md`, `docs/CODE_MAP.md`,
   `docs/TESTING.md`, `docs/RUNTIME.md`, `docs/OPERATIONS.md`,
   `docs/DATA_MODEL.md` 중 존재하고 필요한 파일
6. 로드맵이 별도 파일에 있으면 해당 파일 (ROADMAP.md, docs/ROADMAP.md 등)

긴 P0 설계 문서, `docs/JUDGMENT_SYSTEM.md`, `docs/design/archive/`는 기본으로
열지 않는다. 현재 상태 판단에 꼭 필요할 때만 이유를 밝히고 필요한 부분만 읽는다.
